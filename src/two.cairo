...
//     fn mint(ref self: TContractState, recipient: ContractAddress, amount: u128) -> bool;
...
//         let deployer: ContractAddress = 0x0636F87e64eB229D5C139b052fe27F63253F57Fe1023167e2997bFEC738A922F;
...
//     #[abi(embed_v0)]
//     impl erc20Impl of super::erc20Traits<ContractState>{
...
//         fn mint(ref self: ContractState, recipient: ContractAddress, amount: u128) -> bool {
